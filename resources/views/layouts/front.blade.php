...
<head>
    ...
    <title>@yield('title') - Spurgeon</title>
                ...
                <nav class="s-header__nav-wrap">
                    ...
                    <ul class="s-header__nav">
                        ...
                        <li class="has-children">
                            ...
                            <ul class="sub-menu">
                                <li><a href="/pages/category">Design</a></li>
                                <li><a href="/pages/category">Lifestyle</a></li>
                                <li><a href="/pages/category">Inspiration</a></li>
                                <li><a href="/pages/category">Work</a></li>
                                <li><a href="/pages/category">Health</a></li>
                                <li><a href="/pages/category">Photography</a></li>
                            </ul>
                        </li>
                        <li class="has-children">
                        ...
                        <li><a href="/pages/styles" title="">Styles</a></li>
                        <li><a href="/pages/about" title="">About</a></li>
                        <li class="current-menu-item"><a href="/pages/contact" title="">Contact</a></li>
